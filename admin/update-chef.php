...
<?php if( isset($_GET['id']) ){
                $id = $_GET['id'];
                $chef = $obj->getSingleData("chefs","id",$id);
              }
        ?>
<!-- ============================================================== -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <h4 class="mb-0 text-white">Update Chef</h4>
                    </div>
                    <form id="updateChefForm">
                        <?php foreach( $chef as $value ){ ?>
                        <div class="form-body">
                            <div class="card-body">
                                <div class="row pt-3">
                                    <div class="col-md-6">
                                ...
                                <div class="row pt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="twitter" class="form-control" required="required" placeholder="Username" value="<?php echo $value['twitter']; ?>">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                ...
                                <div class="row pt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="google_plus" class="form-control" required="required" placeholder="Username" value="<?php echo $value['google_plus']; ?>">
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12" id="imageDiv">
                                                ...
                                                <img src="../kusina/images/chefs/<?php echo $value['image']; ?>" class="img-responsive" id="tempImg">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
<script>
    $(document).ready(function(e) {
        ...
        $('#updateChefForm').submit(function(e) {
            e.preventDefault();
        ...
        //    if( file_data === undefined ){
          //  var file_data = $('#image').prop('files')[0];
            ...
            form_data.append('google_plus', google_plus);
            form_data.append('instagram', instagram);
            form_data.append('oldImg', oldImg);
            form_data.append('file', file_data);
            $.ajax({
                url: 'UpdateChefAjax.php', // point to server-side PHP script 
                ...
                success: function(response) {
                    if (response !== "0") {
                        Swal.fire("Done!", "Chef Updated Successfully", "success");
                    } else {
                        Swal.fire({
                            type: 'error',
                            title: 'Oops...',
